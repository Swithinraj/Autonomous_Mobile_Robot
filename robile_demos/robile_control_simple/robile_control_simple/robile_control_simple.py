...
class CmdVelocityPublisher(Node):
    ...
    def timer_callback(self):
        ...
        msg.linear.x = 0.3 # m/s; this is example code, you need to change this section according to the required behavior
        msg.angular.z = 0.5 # rad/s -- z axis is used in Twist for Angular speed
