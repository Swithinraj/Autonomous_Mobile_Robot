...
# At the corner
    #x_pose = LaunchConfiguration('x_pose', default='3.407752')
    #y_pose = LaunchConfiguration('y_pose', default='-1.988744')
    
# Aligned but away
    #x_pose = LaunchConfiguration('x_pose', default='-3.321129')
    #y_pose = LaunchConfiguration('y_pose', default='-1.988744')

# Facing the wall
    #x_pose = LaunchConfiguration('x_pose', default='2.956688')
    #y_pose = LaunchConfiguration('y_pose', default='-1.988744')
